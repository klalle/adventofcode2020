        ...
        while(i<costList.size){
            ...
            while(j<costList.size) {
                ...
                while(k<costList.size) {
                    //println("$i = ${costList.get(i)}")
                    if (costList[i] + costList[j]+ costList[k] == 2020) {
